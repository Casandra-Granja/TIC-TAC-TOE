...
public class Tauler {
    ...
    public boolean filaIguals(int f) {
        ...
        for (int c = 0; c < caselles[0].length - 1; c++) {
            b = b &&
                    caselles[f][c].valor == caselles[f][c + 1].valor;
        }
        return (b &&
    ...
    public boolean columnaIguals(int c){
        ...
        for(int f = 0; f< caselles.length-1; f++){
            b = b &&
                    caselles[f][c].valor== caselles[f+1][c].valor;
        }
        return b &&
    ...
    public boolean diagonalDescIguals(){
        ...
        for(int d = 0; d< caselles.length-1; d++) {
            b = b && caselles[d][d].valor ==
                    caselles[d+1][d+1].valor;
        }
        return b &&
    ...
    public boolean diagonalAscIguals(){
        ...
        for(int d=0; d <nc; d++){
            b = b && caselles[nc-d][d].valor ==
                    caselles[nc-d-1][d+1].valor;
        }
        return b &&
                caselles[nc][0].valor!= Casella.VALOR.BLANC;
    }
